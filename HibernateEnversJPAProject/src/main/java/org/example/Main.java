...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            DetalleFactura dfac1 = DetalleFactura.builder().build();
            DetalleFactura dfac2 = DetalleFactura.builder().build();
            ...
            Categoria cat3 = Categoria.builder().denominacion("Pedecedero").build();
            ...
            Domicilio dom1 = Domicilio.builder().nombreCalle("Le Parc").numero(122).build();
            Domicilio dom2 = Domicilio.builder().nombreCalle("Rivadavia").numero(548).build();

            Cliente cli1 = Cliente.builder().nombre("Gabriel").apellido("Badui").dni(45715164).build();
            Cliente cli2 = Cliente.builder().nombre("Alejo").apellido("Carobolante").dni(45360753).build();
